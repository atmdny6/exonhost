              ...
              t(this).click(function () {
                ...
                if (
                  ...
                  if ("" != r) {
                    ...
                    s = null != r.match(c) ? r.replace(c, s) : r + "|" + s;
                  } else s = "#" + s;
...
$(function () {
  ...
  $(".main-menu > ul > li").hover(
    function () {
      ...
      $(this).find(">ul").show(); // instantly shows the dropdown
    },
    function () {
      $(this).removeClass("hoverClass");
      $(this).find(">ul").hide(); // instantly hides the dropdown
    },
  );
  ...
  // Domain plan expand
  $(".commen-btn.load-more").click(function () {
    $(".great-prices-table").stop(true, true).toggleClass("current");
    $(this).toggleClass("active");
  });

  // email hosing plan expand
  $(".full-specs-features").click(function () {
    $(this).parent().stop(true, true).toggleClass("current");
    $(this).toggleClass("active");
  });

  // Plan Switching
  $("#planSwitching").click(function () {
    if ($(this).is(":checked")) {
      $(".annualPrice").css({ display: "block" });
      $(".monthlyPrice").css({ display: "none" });
    } else if ($(this).is(":not(:checked)")) {
      $(".monthlyPrice").css({ display: "block" });
      $(".annualPrice").css({ display: "none" });
    }
  });
  ...
  $(".cm-height megadrop-content").matchHeight({
    property: "min-height",
  });
}); // main function
